...
def Cafe():
    ...
    Costofmeal = "Rs.",str('%.2f'% (costoffries +  costoflargefries + costofburger  + costofcheeseburger + costofdrinks))
    PayTax=((costoffries +  costoflargefries + costofburger +  costofcheeseburger + costofdrinks)*0.33)
    Totalcost=(costoffries +  costoflargefries + costofburger  + costofcheeseburger + costofdrinks)
    Ser_Charge=((costoffries +  costoflargefries + costofburger  + costofcheeseburger + costofdrinks)/99)
...
txtreference = Entry(f1,font=('ariel' ,16,'bold'), textvariable=rand , bd=6,insertwidth=6,bg="light pink" ,justify='right')
txtreference.grid(row=0,column=1)

lblfries = Label(f1, font=( 'aria' ,16, 'bold' ),text=" French Fries ",fg="black",bd=10,anchor='w')
lblfries.grid(row=1,column=0)
txtfries = Entry(f1,font=('ariel' ,16,'bold'), textvariable=Fries , bd=6,insertwidth=4,bg="white" ,justify='right')
txtfries.grid(row=1,column=1)

lblLargefries = Label(f1, font=( 'aria' ,16, 'bold' ),text="Large French Fries ",fg="black",bd=10,anchor='w')
...
lblCheese_burger.grid(row=4,column=0)
txtCheese_burger = Entry(f1,font=('ariel' ,16,'bold'), textvariable=CheeseBurger , bd=6,insertwidth=4,bg="white" ,justify='right')
txtCheese_burger.grid(row=4,column=1)
...
btnTotal=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="TOTAL", bg="red",command=Cafe)
...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Large French Fries ", fg="steel blue", anchor=W)
